...
- **Full Documentation:** [TOOLS_INDEX.md](https://github.com/nostalgia2812/.github/blob/claude/tooling-filing-system-uG7Gs/TOOLS_INDEX.md#beef)
...
Results are available in the [GitHub Security tab](https://github.com/nostalgia2812/beef/security/code-scanning).
